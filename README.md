...
### Продуктовый помощник. Хранит рецепты, которыми можно делиться с пользователями. Рецепты можно добавить в список избранного, добавить в список покупок и сохранить этот список в формате 'shop_list.txt'.
